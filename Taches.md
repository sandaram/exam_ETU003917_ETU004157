...
- [ ] **[Base/Modèle]** `app/Models/PrefixeModel.php`
...
- [ ] **[Base/Modèle]** `app/Models/BaremeFraisModel.php`
  - Lecture et mise à jour des tranches de montants (`montant_min`, `montant_max`, `frais`) liées aux opérations.
- [ ] **[Fonction/Logique]** Méthode d'ajustement dynamique des tarifs selon le type d'opération (`RETRAIT`, `TRANSFERT`).
- [ ] **[Intégration]** `app/Controllers/Admin/BaremeController.php`
  - Méthodes : `index()`, `update()`.
  - **Routes :** `GET /admin/baremes`, `POST /admin/baremes/update`
- [ ] **[Affichage]** `app/Views/admin/baremes/index.php`
...
- [ ] **[Fonction/Logique]** Calcul des cumulés des commissions perçues par l'opérateur et consolidation des soldes clients.
...
- [ ] **[Affichage]** `app/Views/admin/rapports/gains.php`
  - Tableau de bord des bénéfices/frais perçus par type d'opération.
- [ ] **[Affichage]** `app/Views/admin/rapports/clients.php`
...
- [ ] **[Base/Modèle]** `app/Models/ClientModel.php`
...
- [ ] **[Affichage]** `app/Views/client/retrait.php`
...
- [ ] **[Affichage]** `app/Views/client/historique.php`
